...
x = bdA+(bdB-bdA)/(2*m^(1/3)):(bdB-bdA)/m^(1/3):bdB-(bdB-bdA)/(2*m^(1/3));
y = bdC+(bdD-bdC)/(2*m^(1/3)):(bdD-bdC)/m^(1/3):bdD-(bdD-bdC)/(2*m^(1/3));
z = bdE+(bdF-bdE)/(2*m^(1/3)):(bdF-bdE)/m^(1/3):bdF-(bdF-bdE)/(2*m^(1/3));
