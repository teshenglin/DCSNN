...
xin      = [(bdB-bdA)*rand(1,m)+bdA;(bdD-bdC)*rand(1,m)+bdC;(bdF-bdE)*rand(1,m)+bdE];
xin      = [xin; psi(xin(1,:),xin(2,:),xin(3,:))];
% ... on the boundary ...
xbdc     = [[ones(1,mb)*bdA ones(1,mb)*bdB; (bdD-bdC)*rand(1,2*mb)+bdC;    (bdF-bdE)*rand(1,2*mb)+bdE   ] ...
            [(bdB-bdA)*rand(1,2*mb)+bdA;    ones(1,mb)*bdC ones(1,mb)*bdD; (bdF-bdE)*rand(1,2*mb)+bdE   ] ...
            [(bdB-bdA)*rand(1,2*mb)+bdA;    (bdD-bdC)*rand(1,2*mb)+bdC;    ones(1,mb)*bdE ones(1,mb)*bdF]];
